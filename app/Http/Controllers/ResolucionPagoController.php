...
class ResolucionPagoController extends Controller
{
    ...
    */
    ...
    {
        $s = PlataformaSolicitudAp::where("id_estado_solicitud",2)->get();

        $cuenta = PlataformaSolicitudAp::where("id_estado_solicitud",2)->pluck('n_colegiado');
        ...
        return \PDF::loadView('admin.firmaresolucion.solicitudes_pendientes', compact("datos"))
