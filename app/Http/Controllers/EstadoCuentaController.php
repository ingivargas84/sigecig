...
class EstadoCuentaController extends Controller
{
    ...
    public function getDetalle($id){
        ...
        $query = "SELECT RD.numero_recibo, U.id, S.categoria_id,U.estado_cuenta_maestro_id, U.cantidad, U.updated_at, S.tipo_de_pago, FORMAT(U.abono, 2) as abono, FORMAT(U.cargo, 2 ) as cargo, FORMAT(S.precio_colegiado, 2) as precio_colegiado, U.recibo_id, S.id as id_tipo_pago, U.id_mes, U.año
