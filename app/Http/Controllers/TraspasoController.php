...
class TraspasoController extends Controller
{
    ...
    public function pdfTraspaso(TraspasoMaestro $id)
    {
        ...
        $ciudadDestino = Bodegas::select('descripcion', 'nombre_bodega')->where('nombre_bodega', 'LIKE', $bodegaDestino)->get()->first(); // consulta del nombre de la bodega de destino descripcion es para expendedor
