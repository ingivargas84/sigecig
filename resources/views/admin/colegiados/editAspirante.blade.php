...
@section('content')
<form method="POST" id="EditAspiranteForm" action="{{route('aspirante.update', $codigo)}}">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                             <div class='col-sm-2'>
                              ...
                              <div class='col-sm-4'>
                                ...
                                <input type="hidden" id="idMunicipioNacimiento" value="{{$query->idmunicipionacimiento}}" name="idMunicipioNacimiento">
                              </div>
                              <div class='col-sm-4'>
                                ...
                                <input type="hidden" id="idDepartamentoNacimiento" value="{{$query->iddepartamentonacimiento}}" name="idDepartamentoNacimiento">
                              </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class='col-sm-4'>
                              ...
                              <input type="hidden" id="idPais" value="{{$query->idPaisNacimiento}}" name="idPais">
                            </div>
                            <div class="col-sm-4">
                              ...
                              <input type="hidden" id="idNacionalidad" value="{{$query->idnacionalidad}}" name="idNacionalidad">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                              ...
                              <select onchange="mostrarConyugue();" id="estadoCivil" class="form-control" name="estadoCivil">
                                  ...
                                  @if ($estado->c_civil==$codigo->estadocivil)
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                              ...
                              <input type="hidden" id="idMunicipio" value="{{$query->idMunicipioCasa}}" name="idMunicipio">
                            </div>
                            <div class="col-sm-3">
                              ...
                              <input type="hidden" id="idDepartamento" value="{{$query->idDepartamentoCasa}}" name="idDepartamento">
                            </div>
                            <div class="col-sm-3">
                              <label for="destino" class="control-label">Destino correo</label>
                              <select class="form-control" id="destino" name="destino" type="text">
                                @foreach($dest as $de)
                                @if ($de->destino==$codigo->destinoCorreo)
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                              ...
                              <input type="hidden" id="idMunicipioTrabajo" value="{{$query->idMunicipioTrabajo}}" name="idMunicipioTrabajo">
                            </div>
                            <div class="col-sm-4">
                              ...
                              <input type="hidden" id="idDepartamentoTrabajo" value="{{$query->idDepartamentoTrabajo}}" name="idDepartamentoTrabajo">
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                              ...
                              <input type="hidden" id="idUniversidadGraduado" value="{{$query->universidadGraduado}}" name="idUniversidadGraduado">
                            </div>
                            <div class="col-sm-5">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                @endif
                                <input type="hidden" id="idUniversidadIncorporado" value="{{$query->universidadIncorporado}}" name="idUniversidadIncorporado">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="text-right m-t-15">
                          ...
                          <button id="ButtonAspiranteUpdate" class="btn btn-primary edit">Actualizar Aspirante</button>
                        </div>
                    </div>
                </div>
            </div>
