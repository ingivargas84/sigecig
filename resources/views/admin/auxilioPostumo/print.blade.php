        ...
        <div class="texto ">
            ...
            <p>
                ...
                <div>
                    ...
                    Con número de colegiado <b>{{ $colegiado->c_cliente }}</b> ,fecha de nacimiento,
                    {{ \Carbon\Carbon::parse($fecha)->format('d/m/Y') }}</b>
                ...
                <div>
                    Guatemala,
                    <b>{{ \Carbon\Carbon::parse($fecha_actual)->format('d/m/Y') }}</b>
                </div>
