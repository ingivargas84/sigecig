            ...
            <div class="box-body" style="min-height: 100px;">
                <div class="row">
                    ...
                    <label for="telefono">Fecha de Nacimiento:</label>
                        <input type="text" readonly class="form-control" placeholder="Telefono:" name="fecha_nac" value="">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-sm-9">
                        ...
                        <input type="text" readonly class="form-control" placeholder="Profesion:" name="n_profesion" value="">
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select id="input_banco " class="form-control borde letra1" name="id_banco"s>
                          ...
                          <option value="{{$bancos['id'] }}"> {{$bancos['nombre_banco']}}</option>
                          @endforeach
                        </select>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <select id="input_tipo_cuenta" name="id_tipo_cuenta" class="form-control borde letra1" >
                          ...
                          <option  value="{{$tipo_cuentas['id'] }}" > {{$tipo_cuentas['tipo_cuenta']}}</option>
                          @endforeach
