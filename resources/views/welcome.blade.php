...
<div class="row text-center">
  <div class="col-ms-5 ml-5 pl-5 mt-5 pt-5 text-center centra_vertical">
    <img class="fluid" src="/images/logocig.png" width="400px">
  </div>
  <div class="col-ms-7 ml-5 pl-5 mt-5 pt-5 text-right centra_vertical">
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block fluid" width="900px" src="{{url('images/imagen1.jpg')}}" alt="First slide" >
              </div>
              <div class="carousel-item">
                <img class="d-block fluid" width="900px" src="{{url('images/imagen2.jpg')}}" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block fluid" width="900px" src="{{url('images/imagen3.jpg')}}" alt="Third slide">
              </div>
            </div>
