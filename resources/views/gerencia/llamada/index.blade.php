...
<div class="box">
    <div class="box-header">
      <a class="btn btn-primary pull-right" href="{{route('llamada.new')}}">
        <i class="fa fa-plus"></i>  Ingresar Registro</a>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
...
@push('scripts')
  <script>
    $(document).ready(function() {
      $('.loader').fadeOut(225);
      llamadas_table.ajax.url("{{route('llamada.getJson')}}").load();
    });
